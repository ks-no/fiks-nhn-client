...
class BusinessDocumentSerializerTest : StringSpec({
    ...
    "Test serialization of Dialogmelding 1.0 message with person receiver child" {
        ...
        BusinessDocumentSerializer.serializeNhnMessage(document)
            .validateGeneratedXmlAgainst(start, document, vedleggBytes)
    }
...
private fun String.validateGeneratedXmlAgainst(startTime: OffsetDateTime, document: OutgoingBusinessDocument, vedleggBytes: ByteArray) {
    asClue { xml ->
