...
class BlockingClientWithFastlegeLookup(
    private val client: ClientWithFastlegeLookup,
) {
    ...
    ): UUID = runBlocking { client.sendMessageToGPForPerson(businessDocument, requestParameters) }
